...
replace (
	...
	github.com/thc1006/O-RAN-Intent-MANO-for-Network-Slicing/tn/manager/api/v1alpha1 => ./manager/api/v1alpha1
)
...
require (
	...
	github.com/thc1006/O-RAN-Intent-MANO-for-Network-Slicing/tn/agent/pkg/watcher v0.0.0-20250930061107-3fb231b11e57
