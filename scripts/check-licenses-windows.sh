...
# License compliance check script optimized for Windows Git Bash
...
for module in $modules; do
    ...
    # Run go-licenses check without timeout (Windows compatibility)
    # Only check the main package to speed up
    result=$(go-licenses check . \
